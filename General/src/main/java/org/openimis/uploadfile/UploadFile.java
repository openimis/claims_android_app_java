package org.openimis.uploadfile;
...
/*	FTPClient f;
	...
	public boolean uploadFileToServer(Context ctx,File file){
		...
		try {
			...
			if (Package.equalsIgnoreCase("com.openimis.imisclaims.feedback"))
				UploadPath = FTPFeedbackFolder;
			else if (Package.equalsIgnoreCase("com.openimis.imisclaims.enrollment"))
				UploadPath = FTPEnrollmentFolder;
			else if (Package.equalsIgnoreCase("com.openimis.imisclaims.renewal"))
				UploadPath = FTPPolicyRenewalFolder;
			else if (Package.equalsIgnoreCase("com.openimis.imisclaims.Claim"))
